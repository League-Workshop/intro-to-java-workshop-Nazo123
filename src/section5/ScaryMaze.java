...
if(mouseColor == endcolor) {JOptionPane.showMessageDialog(null, "Tryhard"); scare();}
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("song.wav"));
