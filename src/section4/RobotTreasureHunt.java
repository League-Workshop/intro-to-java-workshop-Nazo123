...
bob.microMove(5);
	...
	private void spaceBarWasPressed() {
		...
		if (robotXLocation >700 && robotXLocation <740 && robotYLocation>400 && robotYLocation<460) {		JOptionPane.showMessageDialog(null, "You must go to the place where eye meets eye");}
		...
		if (robotXLocation >175 && robotXLocation <250 && robotYLocation>0 && robotYLocation<100) {treasureFound();}
	}
